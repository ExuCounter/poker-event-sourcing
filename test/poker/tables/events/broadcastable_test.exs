defmodule Poker.Events.BroadcastableTest do
  ...
  describe "for_broadcast/1" do
    test "sensitive events return :skip" do
      event = %Poker.Tables.Events.DeckGenerated{
        hand_id: "h1",
        table_id: "t1",
        cards: ["As", "Kh"]
      }
    ...
    test "HandFinished has different timing for all_folded" do
      all_folded = %Poker.Tables.Events.HandFinished{
        table_id: "t1",
        hand_id: "h1",
        finish_reason: :all_folded
      }

      showdown = %Poker.Tables.Events.HandFinished{
        table_id: "t1",
        hand_id: "h1",
        finish_reason: :showdown
      }

      assert {:broadcast, _, %{duration: folded_duration}} =
               Broadcastable.for_broadcast(all_folded)

      assert {:broadcast, _, %{duration: showdown_duration}} =
               Broadcastable.for_broadcast(showdown)
    ...
    test "all skipped events return :skip" do
      skipped_events = [
        ...
        %Poker.Tables.Events.ParticipantLeft{
          table_id: "t1",
          participant_id: "p1",
          player_id: "pl1",
          chips: 1000
        },
        %Poker.Tables.Events.ParticipantBusted{
          table_id: "t1",
          hand_id: "h1",
          participant_id: "p1",
          player_id: "pl1"
        ...
        %Poker.Tables.Events.ParticipantBoughtIn{
          participant_id: "p1",
          player_id: "pl1",
          table_id: "t1",
          amount: 1000
        },
        %Poker.Tables.Events.ParticipantBuyInApplied{
          participant_id: "p1",
          table_id: "t1",
          amount: 1000
        }
